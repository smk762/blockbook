...
// KomodoRPC is an interface to JSON-RPC bitcoind service
...
func (z *KomodoRPC) Initialize() error {
	...
	z.Parser = NewKomodoParser(params, z.ChainConfig)
...
func (z *KomodoRPC) GetChainInfo() (*bchain.ChainInfo, error) {
...
func (z *KomodoRPC) GetBlock(hash string, height uint32) (*bchain.Block, error) {
	var err error
	if hash == "" && height > 0 {
...
func (z *KomodoRPC) GetTransactionForMempool(txid string) (*bchain.Tx, error) {
	return z.GetTransaction(txid)
}

// GetMempoolEntry returns mempool data for given transaction
func (z *KomodoRPC) GetMempoolEntry(txid string) (*bchain.MempoolEntry, error) {
	return nil, errors.New("GetMempoolEntry: not implemented")
}

// GetBlockRaw is not supported
func (z *KomodoRPC) GetBlockRaw(hash string) (string, error) {
